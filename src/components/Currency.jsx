...
import { CurrencyContext } from '../utils/CurrencyContext'; // Import CurrencyContext
...
const Currency = () => {
  ...
  return (
    <div className="w-full max-w-md p-8 rounded-lg shadow-2xl" style={{ backdropFilter: "blur(16px) saturate(200%)", backgroundColor: "#080F0F", border: "1px solid rgba(255, 255, 255, 0.125)" }}>
      ...
      <button
        ...
        className="hover:bg-red-400 focus:outline-none  focus:ring-white-500 focus:ring-opacity-50 w-full py-2 mb-4 text-white transition duration-200 bg-[#DF231F] rounded-md"
      >
        Convert
      </button>
